"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.levenshteinDistance = exports.getSkillRelationScore = exports.getSkillClusterIndex = exports.areSynonyms = exports.areFuzzyMatch = void 0; /**
...
exports.areFuzzyMatch = areFuzzyMatch;
 ...
 */
const getSkillClusterIndex = (term) => {
 ...
 */exports.getSkillClusterIndex = getSkillClusterIndex;
const splitComposite = (term) => {
  const parts = term.
 ...
 */
const getSkillRelationScore = (a, b) => {
  const normA = a.toLowerCase().trim();
  const normB = b.toLowerCase().trim();
  ...
  return 0.0;
};exports.getSkillRelationScore = getSkillRelationScore; /* v9-73cbbdd98674130c */
