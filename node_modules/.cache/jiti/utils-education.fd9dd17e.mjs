"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.normalizeEducationLevelCode = exports.normalizeEducationEntries = exports.getEducationLevelOrdinal = exports.getEducationLevelName = exports.getEducationLevelLabel = exports.getEducationLevelCode = exports.EDUCATION_LEVELS = void 0;
...
const EDUCATION_LEVELS = exports.EDUCATION_LEVELS = [
{
  code: 'PRIMARY',
...
const EXACT_LEVEL_LOOKUP = new Map();
...
const normalizeEducationLevelCode = (value) => {
  ...
  return '';
};exports.normalizeEducationLevelCode = normalizeEducationLevelCode;

const getEducationLevelLabel = (code, language = 'en') => {
  if (!code) return '';
...
};exports.getEducationLevelLabel = getEducationLevelLabel;

const getEducationLevelName = (code) => getEducationLevelLabel(code, 'en');exports.getEducationLevelName = getEducationLevelName;

const getEducationLevelCode = (nameOrCode) => normalizeEducationLevelCode(nameOrCode) || nameOrCode;exports.getEducationLevelCode = getEducationLevelCode;

const getEducationLevelOrdinal = (value) => {
...
};exports.getEducationLevelOrdinal = getEducationLevelOrdinal;

const normalizeEducationEntries = (education) =>
Array.isArray(education) ?
education.map((entry) => ({
  ...entry,
  degree_level: normalizeEducationLevelCode(entry.degree_level) || entry.degree_level || ''
})) :
[];exports.normalizeEducationEntries = normalizeEducationEntries; /* v9-116510a37e793467 */
